...
function Shipbutton({label}) {
    ...
    return (
        <div>
            <button type="button" className="leading-[24px] text-[15px] relative p-1 text-[#00D4FF] hover:text-white font-medium flex item-center mt-[4px]" onMouseOver={changeSVG}>
                {label}
                <svg id="originalSvg" className='rotate-[90deg] ml-[5px] mt-[6px]' xmlns="http://www.w3.org/2000/svg" height="15" width="12" viewBox="0 0 448 512">
                    <path fill="#00D4FF" d="M201.4 137.4c12.5-12.5 32.8-12.5 45.3 0l160 160c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L224 205.3 86.6 342.6c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l160-160z" />
                </svg>
