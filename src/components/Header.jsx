...
function Header() {
  return (
      <section className="Section HomepageHero theme--White accent--Slate Section--bleed1 Section--bleed2 Section--paddingNormal Section--hasGuides">
                  ...
                  <div className='Section__layoutContainer'>
                      <div className='Section__layout'>
                          <div className='ColumnLayout' data-columns='2,2'>
                              <section className="Copy HomepageHero__title variant--Superhero">
                                  <header className="HomepageHeroHeader HomepageHeroHeader--hasCaption" data-js-controller="HomepageHeroHeader">
                                      <div data-experiment-id="wpp_homepage_merchandising_live_demo_series" data-experiment-control="true" data-experiment-component-id="homepageHeaderCaption"></div>

                                      <h1 className="HomepageHeroHeader__title !text-[94px] !leading-[98px]">Financial
                                          infrastructure for the internet</h1>
                                      <div className='HomepageHeroGradient Gradient' id='headergrad'>
                                          <canvas className="Gradient__canvas" data-js-controller="Gradient" data-js-darken-top
                                              data-transition-in></canvas>
                                      </div>
                                      <div
                                          className="HomepageHeroHeader__title HomepageHeroHeader__title--overlay HomepageHeroHeader__title--burn !text-[94px] !leading-[98px]"
                                          data-js-target-list="HomepageHeroHeader.title" aria-hidden="true">Financial infrastructure for the
                                          internet</div>
                                      <div className="HomepageHeroHeader__title HomepageHeroHeader__title--overlay !text-[94px] !leading-[98px]"
                                          data-js-target-list="HomepageHeroHeader.title" aria-hidden="true">Financial infrastructure for the
                                          internet</div>
                                  </header>
                                  ...
                                  <footer className="Copy__footer">
                                      <div className="Copy__ctaContainer">
                                        <Payments label='Start Now'></Payments>
                                        <Contactbutton label='Contact Sales'></Contactbutton>
                                      </div>
                                  </footer>
                              </section>
                              <div className='HomepageHeroGraphic HomepageHero__graphic'>
                                              ...
                                              <div className="DashboardGraphic__charts">
                                                  <div className="DashboardGraphic__column DashboardGraphic__column--large">
                                                      ...
                                                      <div className="DashboardGraphic__chartAxis">
                                                          ...
                                                          <span
                                                              className="DashboardGraphic__mutedData DashboardGraphic__mutedData--accent DashboardGraphic__axisNow">Now</span>
                                          ...
                                          <div className="CheckoutPhoneGraphic">
                                              <div className="CheckoutPhoneGraphic__image">
                                                  <div className="HomepageIncrementPhone__imageContainer">
                                                      ...
                                                      <svg className="HomepageIncrementPhone__image HomepageIncrementPhone__image--front"
                                                          viewBox="0 0 460 700">
                                                          <defs>
                                                              <linearGradient id="HomepageIncrementPhone__imageGradientA" x1="50%" x2="50%" y1="0%"
                                                                  y2="88.24%">
                                                                  <stop offset="0%" stopColor="#AC9CC0" />
                                                                  <stop offset="100%" stopColor="#F2D6DF" />
                                                              </linearGradient>
                                                              <linearGradient id="HomepageIncrementPhone__imageGradientB" x1="50%" x2="50%" y1="0%"
                                                                  y2="100%">
                                                                  <stop offset="0%" stopColor="#6F74A9" />
                                                                  <stop offset="80%" stopColor="#515997" />
                                                                  <stop offset="100%" stopColor="#323C83" />
                                                              </linearGradient>
                                                              <linearGradient id="HomepageIncrementPhone__imageGradientC" x1="0%" x2="100%" y1="50%"
                                                                  y2="50%">
                                                                  <stop offset="0%" stopColor="#B1AFCC" />
                                                                  <stop offset="100%" stopColor="#7B80B1" />
                                                              </linearGradient>
                                                              <linearGradient id="HomepageIncrementPhone__imageGradientD" x1="0%" x2="100%" y1="0%"
                                                                  y2="0%">
                                                                  <stop offset="0%" stopColor="#EB938A" />
                                                                  <stop offset="90%" stopColor="#E6887F" />
                                                                  <stop offset="100%" stopColor="#B74840" />
                                                              </linearGradient>
                                                              <linearGradient id="HomepageIncrementPhone__imageGradientE" x1="0%" x2="100%" y1="50%"
                                                                  y2="50%">
                                                                  <stop offset="0%" stopColor="#FFF" stopOpacity="0" />
                                                                  <stop offset="100%" stopColor="#FFF" stopOpacity=".5" />
                                                              </linearGradient>
                                                              <linearGradient id="HomepageIncrementPhone__imageGradientF" x1="50%" x2="50%" y1="60%"
                                                                  y2="100%">
                                                                  <stop offset="0%" stopColor="#4FBED4" />
                                                                  <stop offset="100%" stopColor="#439CCA" />
                                                              </linearGradient>
                                                              <linearGradient id="HomepageIncrementPhone__imageGradientG" x1="50%" x2="50%" y1="0%"
                                                                  y2="100%">
                                                                  <stop offset="0%" stopColor="#52468C" stopOpacity=".8" />
                                                                  <stop offset="100%" stopColor="#52468C" stopOpacity=".2" />
                                                              </linearGradient>
                                                              <linearGradient id="HomepageIncrementPhone__imageGradientH" x1="50%" x2="50%" y1="0%"
                                                                  y2="100%">
                                                          ...
                                                          <rect width="460" height="28" x=".01" y="211"
                                                              fill="url(#HomepageIncrementPhone__imageGradientB)" />
                                                          ...
                                                          <path fill="#8888B5"
                                                              d="M460 60H231.5c36.15 0 151.64-18.83 214.75-50.2A39.9 39.9 0 0 1 460 40v20z" />
                                                          <rect width="75" height="461" x="128" y="239"
                                                              fill="url(#HomepageIncrementPhone__imageGradientD)" />
                                                      ...
                                                      <div className="ApplePaySheet__faceID">
                                                          <div className="Face " data-js-controller="FaceIdAnimation" data-js-follow-mouse>
                                                              ...
                                                              <div className="Face__borders" data-js-target="FaceIdAnimation.borders">
                                                                  <svg className="Face__border--copy" width="100" height="100"
                                                              ...
                                                              <svg className="Face__features" width="100" height="100"
                                                                  ...
                                                                  <path className="Face__mouth" d="M37,68 A20,20,0,0,0,63,68"
                                                                      data-js-target="FaceIdAnimation.mouth"></path>
                                                              </svg>
