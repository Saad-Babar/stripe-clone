...
function Tabsbutton({label}) {
    ...
    return (
        <div className='mt-[-50px] ml-[20px]'>
            <button type="button" className="leading-[24px] text-[15px] relative p-1 text-white hover:text-white/70 font-medium flex item-center mt-[4px]" onMouseOver={changeSVG}>
                {label}
